...
st.set_page_config(
    page_title="AI Agent Action Firewall",
    page_icon="🛡️",
    layout="wide"
)

st.title("🛡️ AI Agent Action Firewall — Live Security Dashboard")
st.markdown("Real-time deterministic policy enforcement and audit feed for LLM tool executions.")
...
st.info("No logs recorded yet. Run a demo scenario or test suite to populate audit records.")
